...
def decide_attack(result_list,classifier):
    ...
    if result_list[-1]==0:
        return 0,0,attack_method_list[0][1](classifier,attack_method_list[0][2][0][0]),True,0#current_attack_n,para,current_attack,b
    ...
    if previous_acc<0.4 or previous_para_n>=2:
        if previous_attack_n<8:
            overall_mark+=1
            return previous_attack_n+1,0,attack_method_list[previous_attack_n+1][1](classifier,attack_method_list[previous_attack_n+1][2][0][0]),True,overall_mark
        else:
            return 0,0,attack_method_list[0][1](classifier,attack_method_list[0][2][0][0]),False,0
    
    else:
        return previous_attack_n,previous_para_n+1,attack_method_list[previous_attack_n][1](classifier,attack_method_list[previous_attack_n][2][previous_para_n+1][0]),True,overall_mark
